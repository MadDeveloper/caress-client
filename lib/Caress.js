 ...
 * https://github.com/MadDeveloper/caress-client
...
;(function(undefined) {
  ...
  try {
    var noNodeClass =
      ({ toString: 0 } + "", toString.call(window.document || 0) == objectClass)
  } catch (e) {}
  ...
  var isKeysFast =
    nativeKeys && /^.+$|true/.test(nativeKeys + !!window.attachEvent)
  ...
  cloneableClasses[arrayClass] = cloneableClasses[boolClass] = cloneableClasses[
    dateClass
  ...
  function createBound(func, thisArg, partialArgs) {
    ...
    function bound() {
      ...
      if (this instanceof bound) {
        ...
        return result && objectTypes[typeof result] ? result : thisBinding
      }
  ...
  var keys = !nativeKeys
    ...
    : function(object) {
        ...
        if (
          type == "function" &&
          propertyIsEnumerable.call(object, "prototype")
        ) {
          return shimKeys(object)
        }
        return object && objectTypes[type] ? nativeKeys(object) : []
      }
...
;(function(namespace) {
  ...
  define(function(require, exports, module) {
    ...
    var Client = (Caress.Client = function Client(options) {
      ...
      this.onObjectAlive = options.onObjectAlive || function() {}
    ...
    Client.prototype.processCursorAlive = function(packet, message) {
      ...
      var activeCursors = _.map(message.sessionIds, function(id) {
        return id.toString()
      })
      var notActiveCursors = _.difference(
    ...
    Client.prototype.processObjectAlive = function(packet, message) {
      ...
      var activeObjects = _.map(message.sessionIds, function(id) {
        return id.toString()
      })
      var notActiveObjects = _.difference(
      ...
      this.onObjectAlive({ active: activeObjects, removed: notActiveObjects })
    }
    ...
    Client.prototype.processBlobAlive = function(packet, message) {
      ...
      var activeBlobs = _.map(message.sessionIds, function(id) {
        return id.toString()
      })
      var notActiveBlobs = _.difference(
     ...
     */
    var Touch = (Caress.Touch = function Touch(
      target,
      identifier,
      clientX,
      clientY,
