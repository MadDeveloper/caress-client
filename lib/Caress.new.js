...
;(function(root, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    define(["underscore", "socket.io-client"], function(_, io) {
      return (root.Caress = factory(_, io))
    })
  } else if (typeof module === "object" && module.exports) {
    // Node. Does not work with strict CommonJS, but
    // only CommonJS-like environments that support module.exports,
    // like Node.
    module.exports = factory(require("underscore"), require("socket.io-client"))
  } else {
    // Browser globals
    root.Caress = factory(root._, root.io)
  }
})(typeof self !== "undefined" ? self : this, (_, io) => {
  /**
   * Caress namespace.
   *
   * @namespace
  ...
  const Client = (Caress.Client = function Client(options = {}) {
    ...
    this.onCursorAlive = options.onCursorAlive || function() {}
    this.onObjectAlive = options.onObjectAlive || function() {}
    this.onBlobAlive = options.onBlobAlive || function() {}
  ...
  Client.prototype.processCursorAlive = function(packet, message) {
    ...
    this.onCursorAlive({ active: activeCursors, removed: notActiveCursors })
  }
  ...
  Client.prototype.processBlobAlive = function(packet, message) {
    ...
    this.onBlobAlive({ active: activeBlobs, removed: notActiveBlobs })
  }
  ...
  TuioObject.prototype.coherceToTouch = function() {
    ...
    const rotationAngle = this.aAngle
    const force = this.force
